...
const handleRemoveFromCart = (product) => {
    ...
    setAddedToCart((prevState) => ({
      ...prevState,
      [product.name]: false, // Set the product name as key and value as false to indicate it's removed from the cart
    }));
  };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <span className="cart-badge">{Object.values(addedToCart).filter(value => value === true).length}</span>
                    </h1>
                    </a>
                    </div>
                </div>
    ...
    <div className="title-container" key={index}>
        ...
        <div className="product-list">
            ...
            <div className="product-card" key={plantIndex}>
                ...
                <div className="cart-item-cost product-price">{plant.cost}</div>
                <div className="product-title">{plant.name}</div>
                {/*Similarly like the above plant.name show other details like description and cost*/}
                <button
  className="product-button"
  onClick={() => handleAddToCart(plant)}
  disabled={!!addedToCart[plant.name]} // Disable if the product is already added
>
  {addedToCart[plant.name] ? 'Added to Cart' : 'Add to Cart'}
                ...
                <CartItem onContinueShopping={handleContinueShopping} handleRemoveFromCart={handleRemoveFromCart} />
            )}
        </div>
    );
}
